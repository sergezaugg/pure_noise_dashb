...
if 'di_li' not in ss:
    ss['di_li'] = {}
    ss['di_li']['empty22'] = "initial" # {}

# to keep track of user inputed params
if 'upar' not in ss:
    ss["upar"] = {
        "par01" : 1000,
        "par02" : "initial",
        "par03" : 2**np.arange(0,5), # [1,10,100,1000], 
        "par04" : 1, 
        "par05" : 10, 
        "par10" : 500, 
        "par11" : 500, 
...
with st.sidebar:
    ...
    _ = st.slider("Width",  min_value=100, max_value=2000, value=500, step=100, key="wid10", on_change=update_ss, args=["wid10", "par10"])
